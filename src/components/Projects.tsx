...
const projects: Project[] = [
  ...
  {
    title: 'TenantHub',
    description: 'Tenant Lifecycle Management Platform',
    longDescription:
      'A comprehensive platform for managing the complete tenant lifecycle. Features Tenant Validator for config validation, One Click Tenant Setup (OCTS) for automated provisioning, and Tenant Decommissioner for clean offboarding.',
